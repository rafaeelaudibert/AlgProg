...
int ghostsControl(int*, pacmanInfo, clock_t*, char[30][100], ghostsInfo*, int, int); ///Controls ghost movement
void moveGhost(pacmanInfo, char[30][100], ghostsInfo*, int); ///Move the ghosts
void showGhosts(pacmanInfo, char[30][100], ghostsInfo*, int); ///Print the ghosts
...
int checkGhostCollision(pacmanInfo, int*, ghostsInfo*); ///Collision between ghosts and the pacman
void reviveGhosts(ghostsInfo *ghostsInfo, int); ///Revives a ghost
