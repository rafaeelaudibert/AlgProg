...
//Variaveis Globais
pacmanInfo pacman, pacman_origin; //Pacman informations
...
int main()
{
    ...
    startLab(lab, &totalPacDots, &pacman, &pacman_origin, &fantasmas, &ghosts_origin); // Set the initial positions of the game
