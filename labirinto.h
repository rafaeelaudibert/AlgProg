...
int showLab(char[30][100], int*, pacmanInfo*, ghosts*, ghosts); //Prints the original lab
int startLab(char[30][100], int*, pacmanInfo*, ghosts*, ghosts*); //Sets initial positions
